@extends('layouts.app')
@section('title', 'Tambah Jenis Galon')
@section('content')
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('galon.save') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="basicInput">Jenis Galon</label>
                                <input type="text" class="form-control" id="basicInput" name="namaGalon"
                                    placeholder="Masukkan Jenis Galon">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="basicInput" name="harga"
                                    placeholder="Masukkan Harga Galon">
                            </div>
                        </div>
                    </div>
            </div>
